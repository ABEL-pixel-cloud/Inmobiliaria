...
describe('CategoryFormComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [  CommonModule,OrganismsModule,AtomsModule, MoleculesModule, HttpClientTestingModule, ToastrModule.forRoot(), ReactiveFormsModule],
  ...
  it('should create', () => {
   ...
   it('debería llamar al servicio si el formulario es válido', () => {
    component.formUse.controls['name'].setValue('Casas de lujo.');
    component.formUse.controls['description'].setValue('Casa de lujo equipadad con utima tecnologia.');

    component.sendData();

    expect(mockToastr.success).toHaveBeenCalledWith('ok');
    expect(mockCategoryService.postData).toHaveBeenCalled();

  });

  it('no debería llamar al servicio si el formulario es inválido', () => {
  component.formUse.controls['name'].setValue('');
  component.formUse.controls['description'].setValue('');
...
it('debería mostrar un toastr de error si el servicio falla', () => {
  ...
  component.formUse.controls['name'].setValue('Categoría X');
  component.formUse.controls['description'].setValue('Descripción de prueba');
